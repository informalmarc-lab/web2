      ...
      <section className={styles.hero}>
        <div className={styles.heroContent}>
          ...
          <div className={styles.storyText}>
            <p>
              Elisa didn&apos;t start Omega because she wanted to run an agency.
            </p>
            <p>
            ...
            <p>
              For Elisa, those numbers aren&apos;t just milestones. They&apos;re
              proof that when creators are supported instead of exploited,
              everyone wins.
            </p>
            <p>
      ...
      <section className={styles.splitSection}>
        <div>
          ...
          <p className={styles.lead}>
            You don&apos;t need experience. You don&apos;t need a following. You
            don&apos;t need to know anything about streaming.
          </p>
          <p>
        ...
        <div className={styles.beliefs}>
          ...
          <ul>
            <li>
              ✓ Your account is yours. We will never ask for your login or
              control your profile.
            </li>
            <li>
              ✓ Your money is yours. It goes from the platform directly to you.
              We never see it.
            </li>
            <li>
              ✓ Your time is yours. No mandatory schedules, no performance
              quotas.
            </li>
            <li>
              ✓ You can leave whenever you want. No lock-in, no penalties, no
              drama.
            </li>
          </ul>
        </div>
